...
with open('../prufa/index.html', 'w', encoding='utf-8') as file:
    file.write(index_html)

with open('../prufa/bread.html', 'w') as file:
...
for post in POSTS:
    ...
    post_file_path = '../prufa/posts/{slug}.html'.format(slug=post_metadata['slug'])
